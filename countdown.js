...
document.addEventListener("DOMContentLoaded", function () {
    ...
    }, 30000); // 3 seconds after the greeting changes

    setTimeout(function () {
        number6Element.textContent = "永远快乐。妳若不伤，岁月无恙。"; // Display "happy birthday"
    }, 33000); // 3 seconds after the greeting changes
