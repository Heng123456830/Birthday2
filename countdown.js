...
document.addEventListener("DOMContentLoaded", function () {
    ...
    }, 14000); // 3 seconds after the greeting changes
    ...
    }, 16000); // 3 seconds after the greeting changes
    ...
    }, 16300); // 3 seconds after the greeting changes



    setTimeout(function () {
        number7Element.textContent = "一場相遇，來自于緣分，"; // Display "happy birthday"
    }, 17000); // 3 seconds after the greeting changes

    setTimeout(function () {
        number8Element.textContent = "一個真情，來自于誠意，"; // Display "happy birthday"
    }, 18000); // 3 seconds after the greeting changes
    ...
    }, 20000); // 3 seconds after the greeting changes
